...
fn register_v33_information_schema_routines_full_list(registry: &mut BTreeMap<u32, Migration>) {
...
fn register_v34_table_constraints_nulls_distinct(registry: &mut BTreeMap<u32, Migration>) {
